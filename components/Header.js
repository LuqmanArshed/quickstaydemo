...
export default function Header({placeholder}) {
  ...
  return (
    <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-1 px-1 md:px-10'>
        {/* left */}
        ...
        <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm'>
            <input value={searchInput} onChange={(e)=>setSearchInput(e.target.value)} type='text' placeholder={placeholder || 'Start Your Search'} className='flex-grow pl-5 bg-transparent outline-none text-sm text-gray-600 placeholder-gray-300' />
